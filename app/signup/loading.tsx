/**
 * Loading skeleton for /signup — registration page
 */
  ...
  return (
    ...
    >
      <div className="glass w-full max-w-md rounded-2xl p-phi-6">
        ...
        <div className="h-7 w-48 mx-auto rounded-lg mb-2 skeleton-shimmer" />
        <div
          className="h-4 w-56 mx-auto rounded-lg mb-8 skeleton-shimmer"
          style={{ opacity: 0.5 }}
        />
        ...
        <div className="space-y-phi-3">
          ...
          <div>
            <div className="h-3 w-36 rounded mb-2 skeleton-shimmer" />
            <div className="h-12 w-full rounded-xl skeleton-shimmer" style={{ opacity: 0.5 }} />
          </div>

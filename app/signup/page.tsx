        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          {step === 1 && (
            <>
              ...
              <button onClick={() => setStep(2)} className="btn-primary w-full py-3 text-base">
                Continue as {role === 'JOB_SEEKER' ? 'Job Seeker' : 'Employer'} →
              </button>
            </>
          )}
          ...
          {step === 2 && (
            <>
              ...
              {/* Google SSO */}
              <button className="w-full flex items-center justify-center gap-3 border border-gray-200 rounded-xl py-3 px-4 font-medium text-gray-700 hover:bg-gray-50 transition-colors mb-6">
              ...
              <div className="relative mb-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="bg-white px-3 text-gray-400">or fill in your details</span>
                </div>
              </div>

...
export default function ContactLoading() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      >
        <div className="h-8 w-40 mx-auto rounded-lg mb-3 skeleton-shimmer" />
        <div className="h-4 w-64 mx-auto rounded-lg skeleton-shimmer" style={{ opacity: 0.6 }} />
      </div>
      ...
      <div className="max-w-xl mx-auto px-4 py-10">
        <div className="glass rounded-2xl p-phi-6">
          <div className="space-y-phi-4">
            {/* Name field */}
            <div>
              <div className="h-3 w-16 rounded mb-2 skeleton-shimmer" />
            ...
            {/* Message field */}
            <div>
              <div className="h-3 w-24 rounded mb-2 skeleton-shimmer" />
              <div className="h-32 w-full rounded-xl skeleton-shimmer" style={{ opacity: 0.5 }} />
            </div>
            {/* Submit button */}

...
export default function BusinessPage() {
  return (
    <div className="min-h-screen bg-brand-bg">
      ...
      {/* ── Legal Status ── */}
      <section className="py-14 px-4 border-b border-brand-primary/30">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={item.label}
                className="bg-gray-900/60 rounded-2xl p-5 border border-brand-primary/30"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {SHARE_BLOCKS.map((block) => (
              <div
                key={block.label}
                className="flex items-start gap-3 bg-gray-900/60 rounded-xl p-4 border border-brand-primary/30"
              >
      ...
      <section className="py-14 px-4 border-b border-brand-primary/30 bg-brand-bg">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-8">
            <Shield className="w-6 h-6 text-brand-accent" />
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              ...
              <div
                key={item.title}
                className="bg-gray-900/60 rounded-2xl border border-brand-primary/30 p-5"
              >
          ...
          <div className="mt-6 bg-brand-primary/20 border border-brand-accent/20 rounded-2xl p-5">

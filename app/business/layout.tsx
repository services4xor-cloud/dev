...
import { BRAND_NAME, LEGAL, IMPACT_PARTNER } from '@/data/mock/config'
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: `Transparent ownership. Kenyan-registered. M-Pesa business. ${IMPACT_PARTNER.name} affiliated. Built to last.`,
    images: [
      {

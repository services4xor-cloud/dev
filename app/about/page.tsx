      ...
      <section className="max-w-5xl 3xl:max-w-[1600px] mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {STATS.map((stat) => (
            ...
            >
              <div className="text-3xl md:text-4xl font-black text-[#C9A227] mb-2">
                {stat.value}
              </div>
      ...
      <section className="max-w-5xl 3xl:max-w-[1600px] mx-auto px-4 py-16">
        ...
        <div className="grid sm:grid-cols-2 gap-5">
          {VALUES.map((v) => (
            <div
              key={v.title}
              className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800 hover:border-[#C9A227]/30 transition-colors"
            >

          ...
          <div className="flex flex-wrap justify-center gap-2">
            {[
              ...
              <Link
                key={item.label}
                href={item.href}
                className="px-3 py-1.5 rounded-full text-sm text-gray-400 bg-gray-900 border border-gray-800 hover:border-brand-accent/40 hover:text-brand-accent transition-all"
              >
                {item.label}
              </Link>
            ))}

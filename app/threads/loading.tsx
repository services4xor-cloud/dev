    ...
    <div className="min-h-screen" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      >
        <div className="max-w-5xl mx-auto text-center">
          <div className="h-8 w-48 mx-auto mb-4 rounded-lg skeleton-shimmer" />
          <div
            className="h-5 w-80 mx-auto mb-8 rounded-lg skeleton-shimmer"
      ...
      <div className="max-w-5xl mx-auto px-4 py-phi-4">
        ...
        {/* Thread cards grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-phi-3">

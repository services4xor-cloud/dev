...
export default function ReferralPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero */}
      <div className="bg-gradient-to-br from-brand-orange to-orange-600 text-white py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-orange-100 max-w-xl mx-auto">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 space-y-16">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 text-center">
          ...
          <p className="text-gray-500 mb-6">Share this link — every signup counts toward your earnings</p>

          <div className="flex items-center gap-3 bg-gray-50 rounded-xl p-4 border border-gray-200 mb-4">
            <span className="flex-1 text-sm text-gray-700 font-mono truncate">{mockLink}</span>
            <button
              onClick={copy}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition-colors ${
                copied ? 'bg-green-100 text-green-700' : 'bg-brand-orange text-white hover:bg-orange-600'
              }`}
            >
            ...
            {steps.map((step, i) => (
              <div key={step.n} className="relative">
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 h-full">
                  <div className="w-10 h-10 bg-brand-orange rounded-full flex items-center justify-center text-white font-bold mb-4">
                    {step.n}
                  </div>
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            { icon: Users, value: '3,200+', label: 'People hired', color: 'text-brand-orange bg-orange-50' },
            { icon: DollarSign, value: 'KES 16M+', label: 'Bonuses paid out', color: 'text-green-600 bg-green-50' },
            { icon: Star, value: '99%', label: 'On-time payments', color: 'text-brand-teal bg-teal-50' },
          ].map(stat => {
        ...
        <div className="text-center">
          <p className="text-gray-500 mb-4">Not signed up yet?</p>

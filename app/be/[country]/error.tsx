...
export default function CountryGateError({
  ...
  useEffect(() => {
    console.error('[Country Gate Error]', error)
  }, [error])
  ...
  return (
    <div className="min-h-screen bg-brand-bg flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Country Gate unavailable</h2>
        <p className="text-gray-400 text-sm mb-6">
          We couldn&apos;t load this country page right now. Please try again.
        </p>
        {error?.message && (

...
const MOCK_PATHS: PathListItem[] = [
  ...
  },
  {
    ...
    country: 'DE',
    isRemote: false,
    description: 'Join SAP cloud platform team building enterprise solutions.',
    skills: ['SAP S/4HANA', 'TypeScript', 'Cloud Architecture', 'German B2'],
    salaryMin: 65000,
    salaryMax: 85000,
    currency: 'EUR',
    anchorId: 'anchor_sap',
  ...
  },
  {
    ...
    salaryMax: 95000,
    currency: 'CHF',
    anchorId: 'anchor_novartis',
    anchorName: 'Novartis AG',
    status: 'OPEN',
    tier: 'PREMIUM',

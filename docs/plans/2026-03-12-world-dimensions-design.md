...
4. **Who You Are** *(skippable)* — Faith (single select) + Culture (free text)
...
function scoreDimensions(me: DimensionProfile, them: DimensionProfile, market: MarketSignal[]): DimensionScore
```

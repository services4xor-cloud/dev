...
const CONTENT: Record<string, ContentDict> = {
  ...
  fr: {
    ...
    'network.headline': 'Trois types de personnes. Un seul réseau.',
    'network.subtitle':
      'Pas de jargon. Pas de CV qui pourrissent dans les boîtes mail. Juste des Pionniers, des Ancres et des Explorateurs — qui se trouvent mutuellement.',

    // Compass CTA
    'compass.headline': 'Où voulez-vous aller ?',
    'compass.subtitle':
      'Décrivez-nous votre parcours en 3 étapes rapides. Nous vous proposerons des Chemins, des Ancres et des communautés — partout dans le monde.',
    ...
    'anchors.subtitle':
      'Organisations qui ouvrent des Chemins pour les Pionniers. Lodges safari, entreprises technologiques, ONG, hôpitaux — tout Ancre qui croit que le vrai talent change tout.',
    'anchors.postPath': 'Poster un Chemin →',
    'anchors.howItWorks': 'Voir comment ça marche',
    ...
    'auth.back': '← Retour',
    'auth.orFillDetails': 'ou remplissez vos informations',
    ...
    'auth.errorOAuth': 'Impossible de démarrer la connexion Google. Veuillez réessayer.',
    ...
    'ventures.curatedForRoute': 'Sélectionné pour votre route',
    ...
    'onboarding.profileReady':
      'Votre profil est prêt. Nous cherchons les meilleurs Chemins pour vous...',
    ...
    'onboarding.pickOne':
      "Choisissez celui qui vous ressemble le plus. Vous pourrez toujours l'affiner plus tard.",
    'onboarding.whereNow': 'Où êtes-vous en ce moment ?',
    'onboarding.weThink': 'Nous pensons que vous êtes en {country}. Correct ?',
    'onboarding.helpsRoutes': 'Cela nous aide à trouver les meilleures routes pour votre parcours.',
    ...
    'onboarding.skillsSelected':
      '{count} compétences sélectionnées — parfait ! Ajoutez-en pour de meilleurs résultats.',
    ...
    'onboarding.chapterTitle': 'Donnez un titre à votre chapitre',
    ...
    'onboarding.headlinePlaceholder':
      "ex. Guide safari avec 5 ans d'expérience | Swahili et Français",
    'onboarding.charLimit': '/ 120 caractères',
    'onboarding.whatMakesYou': 'Ce qui fait de vous, vous ? (optionnel)',
    ...
    'onboarding.whatsappHint':
      "Incluez l'indicatif du pays. Nous vous enverrons des alertes WhatsApp pour les nouvelles correspondances de Chemins.",
    ...
    'compass.locationHint':
      'Nous utilisons votre localisation pour trouver les meilleures routes et corridors de paiement.',
    ...
    // Country-specific hero
    'hero.tagline.KE': 'Chemins globaux, payés via M-Pesa',
    ...
    'home.whatNext': 'Prochaines étapes',
    ...
    'home.chatPioneers': 'Discuter avec des Pionniers',
    'home.chatPioneersDesc': 'Commencez des conversations avec vos correspondances',
    ...
    'home.visitingFromDesc':
      'Explorez le corridor {from} ↔ {to} — chemins, agents et opportunités reliant les deux pays.',
    'home.viewRoutes': 'Voir les routes',
    'home.corridorRoute': '{from} → {to} Route',
    ...
    'exchange.focus': 'Focus',
    'exchange.focusDesc': 'Résultats filtrés par votre sujet de focus',
    ...
    'world.subtitle':
      'Votre réseau de personnes, Chemins et communautés — évalué par pertinence par rapport à votre identité.',
    'world.focus': 'Focus',
    ...
    'world.setupIdentityDesc':
      "Sélectionnez vos langues sur la page d'accueil pour débloquer votre réseau Monde et commencer à vous connecter avec des personnes, des Chemins et des communautés.",
    ...
    'compass.title': 'Boussole des Routes',
    'compass.pageHeadline': 'Trouvez Votre Route',
    'compass.pageSubtitle':
      "Découvrez les meilleurs corridors pour vos compétences, langues et objectifs. Chaque Route vous connecte à des Chemins, des Pionniers et des opportunités à l'étranger.",
    'compass.yourOrigin': 'Votre origine',
    'compass.routesFrom': 'Routes depuis {country}',
    'compass.corridors': '{count} corridors',
    'compass.routesTo': 'Routes vers {country}',
    ...
    'compass.noRoutes': 'Aucune route cartographiée pour le moment',
    'compass.noRoutesDesc':
      "Les routes pour {country} sont en cours de cartographie. En attendant, explorez les Chemins sur l'Échange ou connectez-vous avec des Pionniers.",
    'compass.exploreExchange': "Explorer l'Échange",
    'compass.directRoute': 'Route directe',
    'compass.partnerRoute': 'Route partenaire',
    'compass.emergingRoute': 'Route émergente',
    ...
    // Pricing page
    'pricing.badge': "Payez de n'importe où — M-Pesa, SEPA, carte ou mobile money",
    'pricing.title': 'Tarification simple et transparente',
    'pricing.subtitle':
      'Les Pionniers naviguent et postulent gratuitement. Les Ancres publient des Chemins à partir de zéro. Évoluez quand vous en avez besoin.',
    'pricing.paymentTitle': "Payez de n'importe où dans le monde",
    'pricing.paymentSubtitle':
    ...
    'pricing.agentDesc':
      'Transférez des Chemins à votre réseau via WhatsApp. Quand un Pionnier est placé grâce à votre recommandation, vous gagnez {rate}% des frais de placement. Pas de plafond.',
    'pricing.agentCta': 'Devenir Agent →',
    'pricing.postFree': 'Publier gratuitement',
    ...
    'pricing.descPremium': 'Visibilité maximale + accompagnement dédié',

    // Exchange detail page
    'exchangeDetail.notFound': 'Non trouvé',
    'exchangeDetail.notFoundDesc': "Cet élément d'échange est introuvable.",
    ...
    'about.heroDesc':
      "BeNetwork est une plateforme de routage de vie axée sur l'identité pour tous — connectant les personnes aux chemins, opportunités et expériences grâce au commerce ouvert, une rémunération équitable et des connexions directes.",
    ...
    'about.missionDesc':
      'BeNetwork connecte chacun aux Chemins, personnes et expériences qui correspondent à son identité. Pays, tribu, langue, métier, foi — vous le définissez, nous le routons.',
    'about.missionP1':
      'Les personnes partout méritent un accès direct aux opportunités qui correspondent à qui elles sont. BeNetwork supprime les intermédiaires et les gardiens, construisant des corridors qui connectent les identités dans plus de 50 pays.',
    'about.missionP2':
      'Nous connectons les Pionniers directement avec les Ancres dans plus de 50 pays. Les paiements transitent par M-Pesa, Flutterwave et les rails locaux — pas par les banques étrangères. Les routes sont construites sur de vrais corridors de visa, pas sur des vœux pieux.',
    ...
    'about.paymentsTitle': "L'argent va où vous allez",
    'about.paymentsDesc':
    ...
    'about.impactDesc':
      "Notre bras communautaire. Soutenir les travailleurs de la conservation, les guides locaux et les éducateurs culturels à travers l'Afrique de l'Est. Chaque réservation via {brand} contribue.",
    'about.learnImpact': 'En savoir plus sur {name}',
    'about.ctaTitle': 'Prêt à trouver votre chemin ?',
    'about.ctaDesc':
      'Lancez votre Boussole. Dites-nous où vous êtes et où vous voulez aller. Nous construirons votre route.',

    // Contact page
    'contact.title': 'Contactez-nous',
    'contact.subtitle':
      'Des questions sur {brand} ? Nous répondons sous {time} les jours ouvrables.',
    ...
    'contact.subjectPath': 'Aide pour la publication de Chemins',
    ...
    'contact.error':
      "Quelque chose s'est mal passé. Veuillez réessayer ou nous écrire directement.",
    'contact.labelEmail': 'Email',
    ...
    'threads.heroDesc':
      "Trouvez vos gens. Chaque identité — pays, tribu, langue, intérêt — a un fil. Rejoignez des communautés qui bougent, travaillent et s'épanouissent ensemble.",
    ...
    'threads.empty': 'Aucun fil ne correspond à votre recherche. Essayez un autre terme.',
    ...
    'charity.learnMore': 'Découvrez ce que nous faisons →',
    'charity.howBanner':
      "Quand vous réservez un Venture ou ouvrez un Chemin sur {brand}, {accent}un pourcentage va à {partner}{/accent} — finançant de vrais programmes dans de vraies communautés. Pas d'intermédiaires. Transparence totale.",
    'charity.impactTitle': 'Notre impact à ce jour',
    ...
    'charity.howTitle': 'Comment ça marche',
    'charity.howSubtitle': 'Le cercle {brand} du travail digne',
    ...
    'charity.step2Title': 'Une part va à {partner}',
    'charity.step2Desc':
    ...
    'charity.step3Desc':
      "Les fonds vont directement à la formation professionnelle, au soutien à la conservation et à l'autonomisation des femmes dans les communautés kényanes.",
    ...
    'charity.showLess': 'Voir moins',
    'charity.today': "Aujourd'hui",
    'charity.partnerTitle': 'Partenariat avec {partner}',
    'charity.partnerDesc':
      'Nous accueillons les partenariats avec les organisations qui partagent notre conviction en un travail digne, le développement communautaire et la conservation.',
    'charity.getInTouch': 'Contactez-nous →',
    'charity.donateTitle': 'Soutenir {partner}',
    'charity.donateDesc':
      'Chaque contribution — grande ou petite — développe les compétences, protège la faune et préserve la culture kényane pour les générations futures.',
    'charity.chooseAmount': 'Choisissez un montant',
    'charity.customAmount': 'Montant personnalisé',
    'charity.mpesaInfo':
      'Donnez via M-Pesa : Paybill {partner} CBO. Vous recevrez les instructions de paiement complètes après avoir cliqué ci-dessous.',
    ...
    'business.heroDesc':
      'Le siège juridique et opérationnel de la plateforme BeNetwork et de tous les Ventures Be[Country]. Enregistré au Kenya. Construit pour le monde.',
    'business.missionTitle': 'Notre mission',
    'business.missionDesc':
      'Un travail digne et des opportunités pour tous, partout. Nous connectons les Pionniers (personnes cherchant leur chemin) avec les Ancres (employeurs et partenaires) au-delà des frontières, des devises et des cultures — en commençant au Kenya, avec une expansion mondiale.',
    ...
    'business.shareDesc':
      'Les identités des actionnaires sont protégées par la confidentialité. La structure est montrée par souci de transparence.',
    'business.divisionsTitle': "Divisions de l'entreprise",
    'business.countriesTitle': "Pays d'opération",
    'business.countriesNext':
      'Prochainement : BeNigeria (NGN + Flutterwave) · BeAmerica (USD + Stripe) · BeGermany entité complète',
    'business.paymentTitle': 'Paiement et contrôle financier',
    'business.bankTitle': 'Compte bancaire à double signature',
    'business.bankDesc':
      "KCB / Equity Bank Kenya. Tous les retraits nécessitent l'approbation du contrôleur financier. Pas d'accès unilatéral.",
    'business.mpesaTitle': 'Caisse M-Pesa Business',
    'business.mpesaDesc':
      'Intégration Lipa na M-Pesa propulsée par Chapa. Collections KES instantanées. Sandbox : Till 174379.',
    'business.globalTitle': 'Rails de paiement mondiaux',
    'business.globalDesc':
      'Stripe (USD/EUR), Flutterwave (NGN), PayPal. Chaque rail activé par pays.',
    'business.financeNote':
    ...
    'business.safariPartner': 'Lodges safari et conservations',
    'business.safariPartnerDesc':
      'Listez vos forfaits sur {brand} Expériences. Touchez les voyageurs du monde entier directement.',
    'business.ngoPartner': 'ONG et partenaires de développement',
    'business.ngoPartnerDesc':
      'Co-financez les projets {partner}. Formation professionnelle, emploi des jeunes, constructions communautaires.',
    'business.corpPartner': 'Ancres corporatifs',
    'business.corpPartnerDesc':
      "Recrutez des Pionniers vérifiés. Publiez des Chemins, sponsorisez des placements, construisez votre équipe en Afrique de l'Est.",
    ...
    'business.charityLink': 'Association {partner}',

    // Fashion
    'fashion.badge': '{company} — Division Mode',
    'fashion.tagline': 'Style. Dignité. Afrique.',
    'fashion.heroDesc':
      'De Nairobi au monde — la mode africaine qui raconte une histoire. Mannequins, créateurs et artistes construisant des carrières avec dignité.',
    ...
    'fashion.missionDesc':
      "{brand} Fashion existe parce que le talent créatif africain mérite des opportunités mondiales — sans l'exploitation, sans les gardiens. Nous construisons des voies sûres, rémunérées et professionnelles du Kenya au monde.",
    'fashion.pathsTitle': 'Trois Chemins dans la mode',
    'fashion.pathsDesc':
      "Que vous défiliez sur le podium, dessiniez la collection ou capturiez l'image — il y a un chemin à votre nom.",
    'fashion.modelTitle': 'Mannequin',
    'fashion.modelDesc':
      'Séances photo professionnelles, campagnes de marque, travail de catalogue. Sûr. Rémunéré. Professionnel. Chaque engagement selon vos conditions.',
    ...
    'fashion.creativeDesc':
      "Photographie, stylisme, coiffure et maquillage, scénographie. Tout l'univers derrière l'objectif. Soyez la vision derrière la marque.",
    ...
    'fashion.openPathsDesc': 'Opportunités rémunérées en attente du bon Pionnier',
    'fashion.viewAll': 'Voir tous les Chemins →',
    'fashion.apply': 'Postuler',
    'fashion.partnersTitle': 'Ancres partenaires',
    'fashion.partnersDesc':
      'Organisations qui font confiance à {brand} Fashion pour les connecter avec des Pionniers vérifiés et talentueux',
    'fashion.ctaTitle': 'Prêt à prendre votre chemin ?',
    'fashion.ctaDesc':
      'Rejoignez {brand} Fashion en tant que Pionnier. Fixez vos tarifs. Choisissez vos séances. Construisez votre carrière avec dignité.',
    'fashion.exploreMedia': 'Explorer la Division Médias →',

    // Media
    'media.badge': '{company} — Division Médias',
    'media.tagline': "Racontez les histoires de l'Afrique. Soyez payé.",
    'media.heroDesc':
      "Marques, ONG, lodges safari et gouvernements ont besoin de contenu africain authentique. Les Pionniers qui savent filmer, monter, écrire et créer — gagnent à l'international depuis le Kenya.",
    'media.applyPioneer': 'Postuler comme Pionnier Médias',
    'media.commissionContent': 'Commander du contenu',
    'media.opportunityTitle': "L'opportunité, c'est maintenant",
    'media.opportunityP1':
      "Le monde a soif de contenu africain authentique. Une marque de voyage allemande a besoin d'un documentaire Maasai. Une ONG britannique a besoin d'images d'impact de Kibera. Un lodge safari américain a besoin de contenu Instagram qui convertit.",
    'media.opportunityP2':
      'Ces clients ont des budgets. Ils veulent du contenu authentique, créé localement — pas des images de stock. Et ils peinent à trouver des créateurs fiables et talentueux au Kenya.',
    ...
    'media.featuredDesc':
      "De vraies commissions de vrais Ancres. Ces Chemins sont ouverts — postulez et racontez l'histoire de l'Afrique.",
    ...
    'media.socialDesc':
      'Les Pionniers qui créent pour les clients {brand} Media ont accès à notre moteur de distribution. Publiez une fois, atteignez partout. Votre contenu va de Nairobi au monde automatiquement — pendant que vous vous concentrez sur la prochaine séance.',
    'media.howItWorks': 'Comment ça marche',
    'media.step1': 'Le Pionnier crée du contenu pour un Ancre (lodge, marque, ONG)',
    ...
    'media.step5': 'Le Pionnier est payé via M-Pesa dans les 48 heures suivant la livraison',
    ...
    // Offerings
    'offerings.yourLocation': 'Votre localisation :',
    'offerings.autoDetected': 'détectée automatiquement',
    ...
    'offerings.descDefault':
      'Sélectionnez une destination ci-dessous, ou parcourez les routes recommandées en fonction de votre localisation. Voyagez, travaillez ou construisez — votre chemin commence ici.',
    'offerings.descDest':
      "Explorez ce que {country} a à offrir — expériences, Chemins professionnels et opportunités d'affaires adaptés à votre route.",
    'offerings.all': 'Tous',
    ...
    'offerings.comingSoonDesc':
      'Nous nous étendons à de nouveaux pays. Utilisez la Boussole pour explorer les routes disponibles.',
    'offerings.openCompass': 'Ouvrir la Boussole',
    'offerings.impactTitle': 'Chaque Venture a un impact',
    'offerings.impactDesc':
      'Un pourcentage de chaque Venture réservé via BeNetwork va à des organisations communautaires — finançant éducation, santé et développement local.',
    'offerings.learnAbout': 'En savoir plus sur {partner}',

    // Be[Country] Gate
    'beCountry.comingSoonTitle': 'Ce Be[Country] arrive bientôt.',
    'beCountry.comingSoonDesc':
      "Nous nous étendons à de nouveaux pays chaque mois. En attendant, {brand} est en direct et rempli d'opportunités.",
    ...
    'beCountry.payDesc':
      'Nous prenons en charge les méthodes de paiement de confiance de votre pays.',
    ...
    'beCountry.crossDesc':
      'La Boussole trouve les meilleures routes pour vous — faisant correspondre vos compétences aux opportunités au-delà des frontières, et vous aidant à naviguer les exigences de visa, les méthodes de paiement et le chemin le plus rapide vers votre prochain chapitre.',
    'beCountry.openCompass': 'Ouvrir la Boussole',
    'beCountry.allVentures': 'Tous les Ventures',
    'beCountry.exploreOther': "Explorer d'autres plateformes Be[Country] :",

    // Pioneer Dashboard
    'pioneer.compassRoute': 'Route Boussole',
    'pioneer.profile': 'Profil',
    ...
    // Agent Landing
    'agent.badge': "Programme d'agents",
    ...
    'agent.heroDesc':
      "Les Agents sont le pont entre les employeurs mondiaux et les talents locaux. Transférez les opportunités d'emploi à votre communauté, suivez chaque placement et gagnez une commission pour chaque travailleur embauché via votre réseau.",
    ...
    'agent.howBadge': 'Comment ça marche',
    ...
    'agent.step3Title': 'Transférer',
    'agent.step3Desc':
      'Partagez les Chemins avec les travailleurs que vous connaissez. Chaque transfert a un code de suivi unique lié à vous.',
    'agent.step4Title': 'Gagner',
    'agent.step4Desc':
      'Quand votre transfert mène à un placement, vous gagnez une commission. Payée mensuellement via M-Pesa.',
    'agent.benefitsBadge': 'Avantages',
    'agent.benefitsTitle': 'Pourquoi devenir Agent ?',
    'agent.benefit1Title': 'Gagnez 10% de commission',
    'agent.benefit1Desc':
      "Chaque fois que quelqu'un que vous avez transféré est placé, vous gagnez 10% des frais de placement. Pas de plafond, pas de limite.",
    'agent.benefit2Title': 'Transférez via WhatsApp',
    'agent.benefit2Desc':
      "Partagez les opportunités avec votre réseau d'un seul geste. WhatsApp, SMS, en personne — ce qui marche.",
    ...
    'agent.ctaDesc':
      "Rejoignez le réseau d'Agents de {brand}. Pas de coût initial. Gagnez une commission sur chaque placement réussi.",
    ...
    'thread.pathsIn': 'Chemins en {name}',
    ...
    'thread.relatedThreads': 'Fils connexes',
    ...
    'venture.notFoundDesc': "Ce Venture n'existe pas ou a été fermé.",
    'venture.browseAll': 'Parcourir tous les Ventures',
    'venture.backToVentures': 'Retour aux Ventures',
    'venture.remoteOk': 'À distance OK',
    ...
    'venture.chapterNote': 'Ouvrir un {chapter} partage votre profil avec cet {anchor}.',
    ...
    'notif.emptyTitle': 'Votre boussole est silencieuse pour le moment.',
    ...
    'notif.prefFooter': 'Les notifications sont envoyées par WhatsApp et email.',
    'notif.updatePrefs': 'Mettre à jour les préférences →',

    // Experience Detail
    'exp.notFoundTitle': 'Venture non trouvé',
    'exp.notFoundDesc':
      "Ce Chemin a peut-être déjà été réclamé, ou n'existe pas encore. Explorez d'autres Ventures ouverts ci-dessous.",
    'exp.backToVentures': '← Retour aux Ventures',
    'exp.bookedThisMonth': '{count} réservé{s} ce mois-ci',
    'exp.duration': 'Durée',
    'exp.maxPioneers': 'Max Pionniers',
    'exp.guests': '{count} invités',
    'exp.destination': 'Destination',
    ...
    'exp.optionalExtras': 'Extras optionnels',
    'exp.meals': 'Repas :',
    'exp.payWith': 'Payer avec',
    'exp.spotsLeft': 'Plus que {count} places pour {date}',
    'exp.pioneersBooked': '{count} Pionniers ont réservé ce mois-ci',
    ...
    'exp.maxGroupSize': 'Taille max du groupe',
    'exp.people': '{count} personnes',
    'exp.provider': 'Prestataire',
    'exp.compassRoute': '🧭 Utilisez la Boussole pour planifier votre route',
    ...
    'exp.madeImpact': 'Vous venez de faire une différence',
    'exp.impactNote':
      "{amount} de votre réservation va directement à l'Organisation Communautaire {name} — finançant l'éducation, la santé et les opportunités au Kenya.",
    'exp.confirmationSent':
    ...
    'exp.mpesaNote':
      'Payez via M-Pesa STK Push. Vous recevrez une invite sur votre téléphone pour confirmer avec votre PIN. Idéal pour les Pionniers basés au Kenya.',
    ...
    'anchor.totalChapters': 'Total des Chapitres',
    ...
    'anchor.compassRecs': 'Recommandations Boussole',
    ...
    'agentDash.tabForwards': 'Mes transferts',
    ...
    'agentDash.forwardWhatsApp': 'Transférer via WhatsApp',
    'agentDash.copyLink': 'Copier le lien',
    'agentDash.copied': 'Copié !',
    'agentDash.forwarded': 'Transféré le {date}',
    'agentDash.commission': 'commission',
    'agentDash.totalEarnings': 'Gains totaux',
    'agentDash.placements': 'Placements',
    'agentDash.totalForwards': 'Total des transferts',
    ...
    'agentDash.noPlacementsYet':
      'Aucun placement pour le moment. Continuez à transférer des Chemins à votre réseau !',
    ...
    'postPath.subtitle': "Ouvrir un Chemin, c'est ainsi que les Ancres construisent leur tribu.",
    ...
    'postPath.pathTitlePlaceholder': 'ex. Guide animalier senior — Spécialiste Big Five',
    'postPath.pathTitleHint':
      'Soyez précis. Les Pionniers parcourent vite — un titre précis gagne.',
    ...
    'postPath.remoteOk': 'À distance OK',
    // Step 2
    ...
    'postPath.descriptionHint':
      'Minimum 100 caractères. La Boussole utilise ceci pour matcher les Pionniers.',
    'postPath.chars': '{count} caractères',
    'postPath.requirements': 'Prérequis',
    'postPath.addReqPlaceholder': 'ex. Permis de conduire valide, ex. FGASA Niveau 2+',
    'postPath.add': 'Ajouter',
    'postPath.noReqYet': 'Aucun prérequis ajouté. Appuyez sur Entrée ou cliquez sur Ajouter.',
    // Step 3
    'postPath.whatSkills': "Qu'apporte un excellent Pionnier ?",
    'postPath.whatSkillsDesc':
      'Ajoutez des compétences — la Boussole les utilise pour trouver les Pionniers les plus adaptés à votre Chemin.',
    ...
    'postPath.addOneSkill':
      'Ajoutez au moins 1 compétence pour que la Boussole puisse trouver les bons Pionniers pour ce Chemin.',
    // Step 4
    'postPath.whoIsFor': 'Pour qui est ce Chemin ?',
    'postPath.whoIsForDesc': 'Aidez la Boussole à diriger les bons Pionniers vers votre Chemin.',
    'postPath.pioneerTypes': 'Types de Pionniers',
    'postPath.pioneerTypesHint':
      'Sélectionnez tous les types adaptés. Laissez vide pour accepter tous.',
    'postPath.preferredOrigins': 'Origines préférées des Pionniers',
    'postPath.preferredOriginsHint':
      'Les Pionniers de ces pays seront pondérés plus haut dans le routage de la Boussole. Laissez vide pour global.',
    // Step 5
    'postPath.whatPay': 'Combien paie ce Chemin ?',
    'postPath.whatPayDesc': 'La transparence sur la rémunération attire des Pionniers engagés.',
    ...
    'postPath.paymentMethodsHint':
      'Comment ce Pionnier sera-t-il payé ? Sélectionnez tous les moyens applicables.',
    // Step 6
    ...
    'postPath.skillsNeeded': 'Compétences requises',
    'postPath.readyToOpen': 'Prêt à ouvrir ce Chemin ?',
    'postPath.readyDesc':
      'La Boussole commencera immédiatement à matcher des Pionniers à votre Chemin. Vous verrez les Chapitres arriver dans votre tableau de bord.',
    'postPath.openThisPath': 'Ouvrir ce Chemin',
    'postPath.openingPath': 'Ouverture du Chemin...',
    // Success
    'postPath.pathIsOpen': 'Le Chemin est ouvert !',
    'postPath.compassRouting':
      'La Boussole dirige maintenant les Pionniers vers {title}. Vous verrez les Chapitres arriver sous peu.',
    ...
    'admin.revenueThisMonth': 'Revenus ce mois-ci',
    ...
    'admin.anchor': 'Ancre',
    'admin.country': 'Pays',
    'admin.totalChapters': 'Total des Chapitres',
    ...
    'admin.status': 'Statut',
    'admin.posted': 'Publié',
    'admin.pauseAllOpen': 'Suspendre tous les ouverts',
    'admin.archiveOld': 'Archiver les anciens (avant 2024)',
    'admin.platformConnections': 'Connexions de plateformes',
    ...
    'discovery.step2.subtitle': 'Ajoutez vos compétences et votre profession (1–5)',
    'discovery.step2.placeholder': 'Tapez une compétence ou une profession...',
    'discovery.step2.selected': '{count}/5 sélectionné{s}',
    'discovery.step2.hint': ' — tapez pour rechercher ou ajoutez la vôtre',
    ...
    'discovery.step3.reachCount': '{count} mode de contact',
    'discovery.step3.reachCountPlural': '{count} modes de contact',
    'discovery.step4.title': 'Qui vous êtes',
    'discovery.step4.optional': 'optionnel',
    'discovery.step4.faith': 'Foi ou croyance',
    'discovery.step4.culture': 'Culture ou ethnicité',
    ...
    'discovery.step5.reachLabel': 'Contact',
    ...
    'exchange.card.highCompatibility': 'Forte compatibilité',
    'exchange.card.sameCountry': 'Même pays',
    'exchange.card.languages': 'Langues',
    'exchange.card.craft': 'Métier',
    'exchange.card.skillsNeeded': 'Compétences requises',
    'exchange.card.connectChat': '💬 Se connecter et discuter',
    ...
    'cookie.forDetails': 'pour les détails.',
    ...
    'messages.setupIdentityDesc':
      "Sélectionnez vos langues sur la page d'accueil pour débloquer les Messages et commencer à vous connecter avec des personnes dans vos communautés.",
    ...
    'messages.conversationStarter': 'Sujet de conversation',
    ...
    'me.noSavedItems': 'Aucun élément enregistré',
    'me.savedItemsHint': 'Enregistrez des Chemins et des Expériences pour les retrouver ici',
    ...
    'me.unknownAnchor': 'Ancre inconnu',
    ...
    'me.offeringsHint': 'Publiez un Chemin pour commencer à héberger',
    ...
    'me.passionAndInterests': 'Passions et intérêts',
    'me.noInterests': 'Aucun intérêt sélectionné',
    'me.reach': 'Contact',
    'me.noReach': 'Aucune préférence de contact définie',
    'me.faith': 'Foi',

...
const CONTENT: Record<string, ContentDict> = {
  ...
  en: {
    ...
    'anchors.headline': 'Are you a Host?',
    'anchors.subtitle':
    ...
    'anchors.postPath': 'Post an Opportunity →',
    ...
    // Nav sections
    'nav.explore': 'Explore',
    'nav.forAnchors': 'For Hosts',
    'nav.about': 'About',
    'nav.startMyCompass': 'Start My Discovery',
    'nav.pioneer': 'Explorer',
    ...
    // Ventures page
    'ventures.allVentures': 'All Experiences',
    ...
    'ventures.openPaths': 'Open Opportunities.',
    'ventures.realVentures': 'Real Experiences.',
    'ventures.chapterStarts': 'Your Exchange Starts Here.',
    'ventures.showAll': 'Show all experiences',
    'ventures.seeAll': 'See all',
    'ventures.noMatch': 'No Opportunities match this filter yet',
    'ventures.noMatchHint':
      'New opportunities are added every day. Check back or try another category.',
    'ventures.areYouAnchor': 'Are you a Host?',
    'ventures.anchorCta':
      'Post an Opportunity and reach 12,000+ Explorers across 50+ countries. Local payment rails included.',
    'ventures.postPath': 'Post an Opportunity →',
    'ventures.featured': 'Featured',
    'ventures.remote': 'Remote',
    'ventures.pioneersNeeded': '{count} Explorer{s} needed',
    ...
    'ventures.featuredPaths': 'Featured Opportunities',
    ...
    'onboarding.openChapter': 'Open My First Exchange',
    ...
    'pricing.pioneersTitle': 'Explorers — always free',
    ...
    'exchangeDetail.chaptersOpened': 'Exchanges Opened',
    ...
    'exchangeDetail.opensConversationAnchor': 'Opens a conversation with the Host',
    ...
    'fashion.applyPioneer': 'Apply as Fashion Explorer',
    ...
    'media.applyPioneer': 'Apply as Media Explorer',
    ...
    'offerings.openCompass': 'Open Discovery',
    ...
    'beCountry.compassFallback': 'Or use Discovery to find your opportunity',
    'beCountry.startCompass': 'Start My Discovery',
    'beCountry.browseVentures': 'Browse Experiences',
    ...
    // Explorer Dashboard
    'pioneer.compassRoute': 'Discovery Route',
    'pioneer.profile': 'Profile',
    'pioneer.openChapters': 'Open Exchanges',
    'pioneer.newMatches': 'New Matches',
    'pioneer.topPaths': 'Top Opportunities for You',
    'pioneer.updateCompass': 'Update Discovery',
    'pioneer.browseAllPaths': 'Browse All Opportunities',
    'pioneer.noChapters': "You haven't opened any exchanges yet.",
    'pioneer.browseVentures': 'Browse Experiences →',
    ...
    'pioneer.tabCompass': '🧭 Discovery',
    'pioneer.tabChapters': '📖 Exchanges',
    ...
    'venture.chapterReview': 'The Host will review your profile. Check your dashboard for updates.',
    ...
    'exp.pioneersBooked': '{count} Explorers booked this month',
    ...
    'exp.moreVentures': 'More Experiences to Explore',
    ...
    'postPath.pioneerTypes': 'Explorer Types',
    ...
    'postPath.readyDesc':
      "Discovery will immediately start matching Explorers to your opportunity. You'll see exchanges arriving in your dashboard.",
    ...
    'admin.pioneerView': 'Explorer View',
    ...
    'admin.pioneers': 'Explorers',
    'admin.anchors': 'Hosts',
    'admin.openPaths': 'Open Opportunities',
    'admin.chapters': 'Exchanges',
    'admin.venturesBooked': 'Experiences Booked',
    ...
    // Exchange Card
    'exchange.card.pioneer': 'Explorer',
    ...
    'me.setupDescription':
      'Select your languages on the homepage to unlock your personal dashboard — manage your opportunities, exchanges, and connections.',
    ...
    'error.returnCompass': 'Return to Discovery',
  ...
  de: {
    ...
    'anchors.headline': 'Bist du ein Host?',
    'anchors.subtitle':
    ...
    'anchors.postPath': 'Eine Chance posten →',
    ...
    'nav.forAnchors': 'Für Hosts',
    'nav.about': 'Über uns',
    'nav.startMyCompass': 'Meine Entdeckung starten',
    'nav.pioneer': 'Entdecker',
    ...
    'ventures.allVentures': 'Alle Erlebnisse',
    ...
    'ventures.openPaths': 'Offene Chancen.',
    'ventures.realVentures': 'Echte Erlebnisse.',
    'ventures.chapterStarts': 'Dein Exchange beginnt hier.',
    'ventures.showAll': 'Alle Erlebnisse anzeigen',
    'ventures.seeAll': 'Alle anzeigen',
    'ventures.noMatch': 'Keine Chancen passen zu diesem Filter',
    'ventures.areYouAnchor': 'Bist du ein Host?',
    ...
    'pricing.pioneersTitle': 'Entdecker — immer kostenlos',
    'pricing.pioneersDesc':
    ...
    'exchangeDetail.opensConversationAnchor': 'Öffnet eine Unterhaltung mit dem Host',
    ...
    'business.browseVentures': 'Experiences durchstöbern',
    ...
    'fashion.applyPioneer': 'Als Fashion-Entdecker bewerben',
    ...
    'media.applyPioneer': 'Als Media-Entdecker bewerben',
    ...
    'offerings.openCompass': 'Discovery öffnen',
    ...
    'beCountry.compassFallback': 'Oder nutze Discovery, um deine Chance zu finden',
    'beCountry.startCompass': 'Meine Discovery starten',
    'beCountry.browseVentures': 'Experiences durchsuchen',
    ...
    'pioneer.openChapters': 'Offene Exchanges',
    'pioneer.newMatches': 'Neue Matches',
    'pioneer.topPaths': 'Top-Chancen für dich',
    'pioneer.updateCompass': 'Discovery aktualisieren',
    'pioneer.browseAllPaths': 'Alle Chancen durchsuchen',
    'pioneer.noChapters': 'Du hast noch keine Exchanges eröffnet.',
    'pioneer.browseVentures': 'Erlebnisse durchsuchen →',
    ...
    'venture.chapterReview': 'Der Host wird dein Profil prüfen. Prüfe dein Dashboard für Updates.',
    ...
    'exp.backToVentures': '← Zurück zu Erlebnissen',
    'exp.bookedThisMonth': '{count} diesen Monat gebucht',
    'exp.duration': 'Dauer',
    'exp.maxPioneers': 'Max. Entdecker',
    'exp.guests': '{count} Gäste',
    'exp.destination': 'Ziel',
    'exp.startingFrom': 'Ab',
    'exp.whyThisVenture': '✦ Warum dieses Erlebnis',
    ...
    'exp.pioneersBooked': '{count} Entdecker haben diesen Monat gebucht',
    ...
    'exp.moreVentures': 'Weitere Erlebnisse entdecken',
    ...
    'postPath.pioneerTypes': 'Entdecker-Typen',
    ...
    'admin.chapters': 'Exchanges',
    'admin.venturesBooked': 'Gebuchte Experiences',
    ...
    'admin.anchor': 'Host',
    'admin.country': 'Land',
    'admin.totalChapters': 'Exchanges gesamt',
    ...
    'me.unknownAnchor': 'Unbekannter Host',
    ...
    'error.returnCompass': 'Zurück zur Discovery',
  ...
  sw: {
    ...
    'anchors.headline': 'Je, wewe ni Mwenyeji?',
    'anchors.postPath': 'Weka Fursa →',
    ...
    'nav.forAnchors': 'Kwa Wenyeji',
    'nav.about': 'Kuhusu',
    'nav.startMyCompass': 'Anza Ugunduzi Wangu',
    'nav.pioneer': 'Mvumbuzi',
    ...
    // Ventures
    'ventures.allVentures': 'Experiences Zote',
    'ventures.openPaths': 'Fursa Wazi.',
    'ventures.realVentures': 'Experiences Halisi.',
    'ventures.chapterStarts': 'Exchange Yako Inaanza Hapa.',
    'ventures.areYouAnchor': 'Je, wewe ni Mwenyeji?',
    'ventures.postPath': 'Weka Fursa →',
    ...
    'pricing.pioneersTitle': 'Wavumbuzi — bure milele',
    'pricing.pioneersDesc':
    ...
    'exchangeDetail.chaptersOpened': 'Exchanges zilizofunguliwa',
    ...
    'exchangeDetail.opensConversationAnchor': 'Inafungua mazungumzo na Mwenyeji',
    ...
    'business.browseVentures': 'Vinjari Experiences',
    ...
    'fashion.applyPioneer': 'Omba kama Mvumbuzi wa Mitindo',
    ...
    'media.applyPioneer': 'Omba kama Mvumbuzi wa Media',
    ...
    'beCountry.compassFallback': 'Au tumia Discovery kupata fursa yako',
    'beCountry.startCompass': 'Anza Discovery Yangu',
    'beCountry.browseVentures': 'Vinjari Experiences',
    ...
    'beCountry.openCompass': 'Fungua Discovery',
    'beCountry.allVentures': 'Experiences Zote',
    'beCountry.exploreOther': 'Gundua mifumo mingine ya Be[Country]:',

    // Explorer Dashboard
    'pioneer.compassRoute': 'Njia ya Discovery',
    'pioneer.profile': 'Wasifu',
    'pioneer.openChapters': 'Exchanges Wazi',
    'pioneer.newMatches': 'Mechi Mpya',
    'pioneer.topPaths': 'Fursa Bora Kwako',
    'pioneer.updateCompass': 'Sasisha Discovery',
    'pioneer.browseAllPaths': 'Vinjari Fursa Zote',
    'pioneer.noChapters': 'Bado hujafungua exchanges zozote.',
    'pioneer.browseVentures': 'Vinjari Experiences →',
    ...
    'exp.pioneersBooked': 'Wavumbuzi {count} walihifadhi mwezi huu',
    ...
    'exp.compassRoute': '🧭 Tumia Discovery kupanga njia yako',
    'exp.moreVentures': 'Experiences Zaidi za Kuchunguza',
    ...
    'postPath.pioneerTypes': 'Aina za Mvumbuzi',
    ...
    'admin.pioneerView': 'Mtazamo wa Mvumbuzi',
    ...
    'admin.chapters': 'Exchanges',
    'admin.venturesBooked': 'Experiences Zilizohifadhiwa',
    ...
    'admin.recentChapters': 'Exchanges za Hivi Karibuni',
    ...
    'admin.anchor': 'Host',
    'admin.country': 'Nchi',
    'admin.totalChapters': 'Exchanges Zote',
    ...
    'me.unknownAnchor': 'Mwenyeji Asiyejulikana',
    ...
    'ventures.showAll': 'Onyesha experiences zote',
    'ventures.seeAll': 'Ona zote',
    'ventures.noMatch': 'Hakuna Fursa zinazolingana na chujio hili',
    ...
    'onboarding.chapterTitle': 'Tuambie kichwa cha exchange yako',
    ...
    'error.returnCompass': 'Rudi kwa Discovery',

...
const CONTENT: Record<string, ContentDict> = {
  ...
  en: {
    ...
    'hero.readyChapter': 'Ready for your next exchange?',
    ...
    'ventures.explorerVentures': 'Explorer Experiences',
    ...
    'onboarding.add': 'Add',
    'onboarding.chapterTitle': 'Tell us your exchange title',
    ...
    'business.browseVentures': 'Browse Experiences',
    ...
    // Explorer Dashboard
    'explorer.compassRoute': 'Discovery Route',
    'explorer.profile': 'Profile',
    'explorer.openChapters': 'Open Exchanges',
    'explorer.newMatches': 'New Matches',
    'explorer.topPaths': 'Top Opportunities for You',
    'explorer.updateCompass': 'Update Discovery',
    'explorer.browseAllPaths': 'Browse All Opportunities',
    'explorer.noChapters': "You haven't opened any exchanges yet.",
    'explorer.browseVentures': 'Browse Experiences →',
    ...
    'explorer.tabCompass': '🧭 Discovery',
    'explorer.tabChapters': '📖 Exchanges',
    ...
    'exp.compassRoute': '🧭 Use Discovery to plan your route',
    ...
    'admin.recentChapters': 'Recent Exchanges',
    ...
    'admin.totalChapters': 'Total Exchanges',
  ...
  de: {
    ...
    'hero.readyChapter': 'Bereit für deinen nächsten Austausch?',
    ...
    'exchangeDetail.chaptersOpened': 'Exchanges eröffnet',
    ...
    'contact.subjectPath': 'Hilfe beim Chance-Posting',
    ...
    'explorer.openChapters': 'Offene Exchanges',
    'explorer.newMatches': 'Neue Matches',
    'explorer.topPaths': 'Top-Chancen für dich',
    'explorer.updateCompass': 'Discovery aktualisieren',
    'explorer.browseAllPaths': 'Alle Chancen durchsuchen',
    'explorer.noChapters': 'Du hast noch keine Exchanges eröffnet.',
    'explorer.browseVentures': 'Erlebnisse durchsuchen →',
    ...
    'exp.compassRoute': '🧭 Nutzen Sie Discovery, um Ihre Route zu planen',
  ...
  sw: {
    ...
    'hero.readyChapter': 'Uko tayari kwa exchange yako ijayo?',
    ...
    // Explorer Dashboard
    'explorer.compassRoute': 'Njia ya Discovery',
    'explorer.profile': 'Wasifu',
    'explorer.openChapters': 'Exchanges Wazi',
    'explorer.newMatches': 'Mechi Mpya',
    'explorer.topPaths': 'Fursa Bora Kwako',
    'explorer.updateCompass': 'Sasisha Discovery',
    'explorer.browseAllPaths': 'Vinjari Fursa Zote',
    'explorer.noChapters': 'Bado hujafungua exchanges zozote.',
    'explorer.browseVentures': 'Vinjari Experiences →',
  ...
  fr: {
    // Navigation
    'nav.startCompass': 'Lancer la Découverte',
    ...
    'hero.readyChapter': 'Prêt pour votre prochain échange ?',
    ...
    'anchors.headline': 'Êtes-vous un Hôte ?',
    'anchors.subtitle':
    ...
    'anchors.postPath': 'Poster une Opportunité →',
    ...
    'nav.forAnchors': 'Pour les Hôtes',
    'nav.about': 'À propos',
    'nav.startMyCompass': 'Lancer Ma Découverte',
    'nav.pioneer': 'Explorateur',
    ...
    // Experiences page
    'ventures.allVentures': 'Tous les Expériences',
    ...
    'onboarding.chapterTitle': 'Dites-nous votre titre de exchange',
    ...
    'onboarding.openChapter': 'Ouvrir Mon Premier Exchange',
    ...
    'pricing.pioneersTitle': 'Explorateurs — toujours gratuit',
    'pricing.pioneersDesc':
    ...
    'business.browseVentures': 'Parcourir les Expériences',
    ...
    'fashion.applyPioneer': 'Postuler comme Explorateur Mode',
    ...
    'media.applyPioneer': 'Postuler comme Explorateur Médias',
    ...
    'offerings.openCompass': 'Ouvrir la Découverte',
    ...
    'beCountry.compassFallback': 'Ou utilisez la Découverte pour trouver votre opportunité',
    'beCountry.startCompass': 'Lancer Ma Découverte',
    'beCountry.browseVentures': 'Parcourir les Expériences',
    ...
    // Explorer Dashboard
    'explorer.compassRoute': 'Itinéraire Découverte',
    'explorer.profile': 'Profil',
    'explorer.openChapters': 'Exchanges Ouverts',
    'explorer.newMatches': 'Nouvelles Correspondances',
    'explorer.topPaths': 'Meilleurs Chemins Pour Vous',
    'explorer.updateCompass': 'Mettre à jour la Découverte',
    'explorer.browseAllPaths': 'Parcourir Tous les Opportunités',
    'explorer.noChapters': "Vous n'avez encore ouvert aucun exchange.",
    'explorer.browseVentures': 'Parcourir les Expériences →',
    ...
    'explorer.tabCompass': '🧭 Découverte',
    'explorer.tabChapters': '📖 Exchanges',
    ...
    'exp.backToVentures': '← Retour aux Expériences',
    'exp.bookedThisMonth': '{count} réservé{s} ce mois',
    'exp.duration': 'Durée',
    'exp.maxPioneers': 'Max Explorateurs',
    'exp.guests': '{count} invité{s}',
    'exp.destination': 'Destination',
    'exp.startingFrom': 'À partir de',
    'exp.whyThisVenture': '✦ Pourquoi cette Expérience',
    ...
    'exp.pioneersBooked': '{count} Explorateurs ont réservé ce mois',
    ...
    'exp.compassRoute': '🧭 Utilisez la Découverte pour planifier votre itinéraire',
    'exp.moreVentures': 'Plus de Expériences à Explorer',
    ...
    'admin.pioneerView': 'Vue Explorateur',
    'admin.mockWarning':
    ...
    'admin.recentChapters': 'Exchanges Récents',
    ...
    'me.setupDescription':
      "Sélectionnez vos langues sur la page d'accueil pour débloquer votre tableau de bord personnel — gérez vos opportunités, exchanges et connexions.",
    ...
    'me.pioneerType': 'Type de Explorateur',
    ...
    'error.returnCompass': 'Retour à la découverte',
  ...
  ar: {
    ...
    'hero.startCompass': 'ابدأ اكتشافي',
    'hero.browseVentures': 'تصفح التجارب',
    'common.pioneers': 'مستكشفون',
    'common.active': 'نشط',
  },
  ...
  hi: {
    ...
    'hero.startCompass': 'मेरी खोज शुरू करें',
  ...
  zh: {
    ...
    'hero.startCompass': '启动我的探索',
    'hero.browseVentures': '浏览体验',
  ...
  es: {
    ...
    'hero.startCompass': 'Iniciar Mi Descubrimiento',
    ...
    'anchors.headline': '¿Eres un Host?',
    'testimonials.headline': 'Viajes reales. Exchanges reales.',
    'common.pioneers': 'exploradores',
  ...
  pt: {
    ...
    'hero.startCompass': 'Iniciar Minha Descoberta',
    'hero.browseVentures': 'Explorar Experiencias',
  ...
  ru: {
    ...
    'hero.startCompass': 'Запустить Моё Открытие',
  ...
  tr: {
    ...
    'hero.startCompass': 'Keşfimi Başlat',
  ...
  id: {
    ...
    'hero.startCompass': 'Mulai Penemuan Saya',

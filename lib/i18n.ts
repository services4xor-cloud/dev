...
const CONTENT: Record<string, ContentDict> = {
  ...
  en: {
    ...
    'hero.subtitle':
      "{brandName} is not a recruitment platform. It's a discovery platform — for Explorers who want to move, grow, and belong somewhere extraordinary.",
    ...
    'business.missionDesc':
      'Dignified work and opportunity for everyone, everywhere. We connect Explorers (people seeking their way) with Hosts (organisations and partners) across borders, currencies, and cultures — starting in Kenya, scaling globally.',
    ...
    'agent.heroTagline': 'You know talent. We know Hosts. Together, we place people.',
    'agent.heroDesc':
      'Agents are the bridge between global Hosts and local talent. Forward opportunities to your community, track every placement, and earn commission for every Explorer who gets placed through your network.',
    'agent.applyCta': 'Apply to become an Agent',
    'agent.viewDemo': 'View Demo Hub',
    ...
    'postPath.goToDashboard': 'Go to Hub',
    ...
    'admin.checkMpesa': 'Check M-Pesa sandbox console',
  ...
  de: {
    ...
    'business.missionDesc':
      'Würdevolle Arbeit und Chancen für alle, überall. Wir verbinden Entdecker (Menschen, die ihren Weg suchen) mit Hosts (Organisationen und Partner) über Grenzen, Währungen und Kulturen hinweg — beginnend in Kenia, weltweit skalierend.',
    ...
    'agent.heroTagline': 'Du kennst Talente. Wir kennen Hosts. Zusammen vermitteln wir.',
    'agent.heroDesc':
      'Agents sind die Brücke zwischen globalen Hosts und lokalen Talenten. Leite Opportunities an deine Community weiter, verfolge jede Vermittlung und verdiene Provision für jeden Explorer, der über dein Netzwerk vermittelt wird.',
    'agent.applyCta': 'Als Agent bewerben',
    'agent.viewDemo': 'Demo-Hub ansehen',
    ...
    'agent.step3Desc':
      'Teile Opportunities mit Explorern, die du kennst. Jede Weiterleitung hat einen einzigartigen Tracking-Code.',
    ...
    'agent.who1': 'Explorer im Gesundheitswesen, Tech oder Gastgewerbe kennst',
  ...
  fr: {
    ...
    // Explorer Dashboard
    'pioneer.compassRoute': 'Itinéraire Découverte',
    'pioneer.profile': 'Profil',

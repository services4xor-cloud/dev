/**
 * Platform Configuration — centralized brand, contact, legal, and social info.
 *
 * Resolves per-country via NEXT_PUBLIC_COUNTRY_CODE.
 * All pages import from here. Never hardcode contact details in pages.
 *
 * Migrated from data/mock/config.ts → lib/platform-config.ts
 */

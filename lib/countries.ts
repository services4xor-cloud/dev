...
const kenyaConfig: CountryConfig = {
  ...
  featuredSectors: [
    { id: 'tech', name: 'Tech and Engineering', emoji: '💻', count: 4200 },
    {
      id: 'safari',
      name: 'Wildlife and Safaris',
      emoji: '🦁',
      count: 850,
    ...
    { id: 'finance', name: 'Finance and Banking', emoji: '💰', count: 1800 },
    { id: 'health', name: 'Healthcare', emoji: '🏥', count: 2100 },
    { id: 'education', name: 'Teaching and Education', emoji: '📚', count: 1500 },
    { id: 'hospitality', name: 'Hospitality', emoji: '🍽️', count: 1200 },
    { id: 'creative', name: 'Creative and Media', emoji: '🎨', count: 680 },
    { id: 'agriculture', name: 'Agriculture and Farming', emoji: '🌾', count: 2100 },
    { id: 'marine', name: 'Marine and Water Sports', emoji: '🌊', count: 450 },
  ],
  popularSearches: [
    'Safari Guide',
    'Software Explorer',
...
const germanyConfig: CountryConfig = {
  ...
  featuredSectors: [
    ...
    { id: 'it', name: 'IT and Software', emoji: '💻', count: 12400 },
    {
      id: 'healthcare',
    ...
    { id: 'logistics', name: 'Logistik und Transport', emoji: '🚛', count: 5400 },
    { id: 'finance', name: 'Finance and Banking', emoji: '🏦', count: 3200 },
...
const switzerlandConfig: CountryConfig = {
  ...
  featuredSectors: [
    { id: 'finance', name: 'Finance and Banking', emoji: '🏦', count: 9200 },
    {
      id: 'pharma',
    ...
    { id: 'hospitality', name: 'Hospitality and Tourism', emoji: '🏔️', count: 5400 },
    { id: 'it', name: 'IT and Software', emoji: '💻', count: 8400 },
    {
      id: 'precision',
    ...
    { id: 'education', name: 'Education and Research', emoji: '🎓', count: 2800 },
  ],
  popularSearches: [
    'Software Engineer',
    'Pharma Research',
...
const usaConfig: CountryConfig = {
  ...
  featuredSectors: [
    ...
    { id: 'finance', name: 'Finance and Fintech', emoji: '💰', count: 28000 },
    ...
    { id: 'aviation', name: 'Aviation and Travel', emoji: '✈️', count: 8200 },
...
const nigeriaConfig: CountryConfig = {
  ...
  impactPartner: {
    name: 'Ọmọ Foundation',
    fullName: 'Ọmọ — Foundation for Youth and Enterprise',
  ...
  featuredSectors: [
    { id: 'tech', name: 'Tech and Fintech', emoji: '💻', count: 12400 },
    { id: 'finance', name: 'Banking and Finance', emoji: '🏦', count: 8200 },
    { id: 'oil-gas', name: 'Oil and Gas', emoji: '⛽', count: 4800 },
    { id: 'telecom', name: 'Telecom', emoji: '📡', count: 2800 },
    { id: 'media', name: 'Nollywood and Media', emoji: '🎬', count: 1200 },
...
export const COUNTRY_META: Record<string, CountrySEOMeta> = {
  ...
  DE: {
    ...
    description:
      'Your guide to professional paths, experiences, and community in Germany. SEPA payments, skilled worker routes, European connections.',
    twitter: '@BeGermany',
    brandName: 'BeGermany',
  },
  CH: {
    ...
    description:
      'Your guide to professional paths, alpine experiences, and community in Switzerland. TWINT, Stripe, cross-border routes.',
  ...
  TH: {
    ...
    description:
      'Your guide to professional paths, tourism experiences, and community in Thailand. PromptPay, Stripe, cultural exchange.',
    twitter: '@BeThailand',
    brandName: 'BeThailand',
  },
  US: {
    ...
    description:
      'Your guide to professional paths, innovation hubs, and diverse communities across America. ACH, Stripe, global connections.',
    twitter: '@BeAmerica',
    brandName: 'BeAmerica',
  },
  NG: {
    ...
    description:
      "Your guide to tech, creative, and professional paths in Nigeria. Flutterwave, Paystack, Africa's largest economy.",
    twitter: '@BeNigeria',
    brandName: 'BeNigeria',
  },
  GH: {
    ...
    description:
      'Your guide to professional paths, cultural heritage, and community in Ghana. MTN MoMo, Flutterwave, West African connections.',
    twitter: '@BeGhana',
    brandName: 'BeGhana',
  },
  ZA: {
    ...
    description:
      'Your guide to professional paths, wildlife experiences, and community in South Africa. EFT, Stripe, continental gateway.',
  ...
  UG: {
    ...
    description:
      'Your guide to professional paths, gorilla trekking experiences, and community in Uganda. MTN MoMo, Airtel Money, East African routes.',
    twitter: '@BeUganda',
    brandName: 'BeUganda',
  },
  TZ: {
    ...
    description:
      'Your guide to professional paths, Serengeti experiences, and community in Tanzania. M-Pesa, Tigo Pesa, East African connections.',
    twitter: '@BeTanzania',
    brandName: 'BeTanzania',
  },
  IN: {
    ...
    description:
      'Your guide to technology paths, cultural experiences, and community across India. UPI, Razorpay, global talent hub.',
    twitter: '@BeIndia',
    brandName: 'BeIndia',
  },
  AE: {
    ...
    description:
      'Your guide to professional paths, business experiences, and community in the UAE. Apple Pay, Stripe, global business hub.',
    twitter: '@BeUAE',
    brandName: 'BeUAE',
  },
  CA: {
    ...
    description:
      'Your guide to professional paths, natural adventures, and multicultural community in Canada. Interac, Stripe, immigration pathways.',
    twitter: '@BeCanada',
    brandName: 'BeCanada',
  },
  GB: {
    ...
    description:
      'Your guide to professional paths, cultural experiences, and community in the UK. Faster Payments, Stripe, global connections.',
    twitter: '@BeUK',
    brandName: 'BeUK',
  },
}

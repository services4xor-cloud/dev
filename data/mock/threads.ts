...
export const MOCK_THREADS: Thread[] = [
  ...
  // ── Religion / Faith ─────────────────────────────────────────
  {
    ...
    description:
      'Connect with Christian communities across countries — from Nairobi chapels to German parishes. Find faith-aligned paths, mission volunteering, and spiritual networks.',
    relatedThreads: ['ke', 'de', 'ug'],
    countries: [],
    memberCount: 8500,
    active: true,
  },
  {
    ...
    description:
      'Discover Muslim communities, mosques, halal-friendly workplaces, and Islamic finance paths across the BeNetwork.',
  ...
  },
  {
    ...
    description:
      'Hindu communities, temple networks, cultural organizations, and dharma-aligned paths from India to East Africa and beyond.',
    relatedThreads: ['in', 'ke', 'ug'],
    countries: [],
    memberCount: 3800,
    active: true,
  },
  {
    ...
    description:
      'Buddhist meditation centers, mindfulness retreats, and contemplative communities across the global BeNetwork.',
  ...
  },
  {
    ...
    description:
      'Traditional African religions, indigenous spiritual practices, and ancestral cultural preservation across communities.',
    relatedThreads: ['ke', 'ng', 'gh', 'tz'],
    countries: [],
    memberCount: 2100,
    active: true,
  },

...
| R21 | Centralized brand/contact/legal config (data/mock/config.ts)        | ✅     | Session 21   |
| R22 | Hero gradient on every public page (from-brand-primary to-brand-bg) | ✅     | Session 22   |
| R23 | Wizard pattern: numbered steps + Continue → on all wizards          | ✅     | Session 22   |
| R24 | Automation agent system for offerings (form intake → digital exec)  | 📋     | Session 21   |
| R25 | Nav bar redesign (quality, world-class)                             | 🔄     | Session 22   |
